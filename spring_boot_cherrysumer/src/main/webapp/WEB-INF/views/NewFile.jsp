  ...
  <a href="/">
        <div class="panel bottom">
            <div class="content">
                ...
                <img src="images/그림.jpg" alt="Original">
            </div>
        </div>
</a>
<a href="/">
        <div class="panel top">
            <div class="content">
                ...
                <img src="images/사진.jpg" alt="Duotone">
            </div>
        </div>
</a>
...
<div class="left"><div class="imgBx">
                <img src="images/${list.memPicture}">
            </div>
            <div class="details">
                <h2>${list.memName} </h2>
...
<div class="show3-1"><img src="images/${list.memPicture}"></div>
</c:forEach>
</div></div>
