...
public class CustomerController {
	...
	/*
	 * @RequestMapping("/customer/customerListAll") public String
	 * customerListAll(Model model) { ArrayList<CustomerVO>
	 * cusList=service.CustomerAll(); model.addAttribute("cusList",cusList); return
	 * "customer/customer";
	 * 
	 * }
	 */
	...
	public String confirm(@PathVariable String cusNo){
	  ...
	  @RequestMapping("/CustomerSearch")
	    public String CustomerSearch(@RequestParam String keyword,
	                                                                Model model){
	...
	// 댓글 작성
	  ...
	  public String posttWirte(ReplyVO vo){
